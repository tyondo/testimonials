        ...
        <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{route('tyondo.testimonial.index')}}">{{config('aggregator.purpose')}}</a>
                    </li>
                    <li class="active">
                        <strong>Edit {{config('ttestimonial.purpose')}}</strong>
                    </li>
                </ol>
            </div>
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        <section class="box ">
            <div class="content-body">
                <div class="row">
                  {!! Form::model($post, ['route' => ['tyondo.testimonial.update', $post->id], 'method' => 'PATCH', 'files' => true ]) !!}
